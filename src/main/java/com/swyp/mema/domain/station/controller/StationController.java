...
//	) {
//		TotalStationRes response = stationService.getSubwayInfo();
...
//	public ResponseEntity<TotalSubwayTimeRes> getAllStationTimeByOpenAPI(
//		@AuthenticationPrincipal CustomUserDetails userDetails
//	) {
//
//		String stationId = "MTRKRK1k210";	// 왕십리 수인분당선
//		String dailyTypeCode = "01";		// 01 : 평일, 02 : 토요일, 03 : 일요일
//		TotalSubwayTimeRes response = stationService.getSubwayTimeByStationId(stationId, dailyTypeCode);
//		return ResponseEntity.ok(response);
//	}
//
//	/**
...
//	public ResponseEntity<TotalNearSubwayRes> getNearStationTimeByOpenAPI(
//		@AuthenticationPrincipal CustomUserDetails userDetails
//	) {
//
//		String stationName = "왕십리";
//		TotalNearSubwayRes response = nearStationService.getNearSubwayByAPI(stationName);
//		return ResponseEntity.ok(response);
//	}
//
//	/**
