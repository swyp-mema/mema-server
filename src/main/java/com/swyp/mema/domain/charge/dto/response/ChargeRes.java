...
public class ChargeRes {
    ...
    private List<PayerInfo> payers;     // 피정산자 정보 리스트

    @Builder
    public ChargeRes(Long chargeId, String content, int totalPrice, int peopleNumber, String payeeNickname, List<PayerInfo> payers) {
